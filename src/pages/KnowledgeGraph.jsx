...
export const GRAPH_NODES = {
  ...
  arabiyyah: {
    ...
    type: 'concept',
    title: 'Al-\u2019Arabiyyah',
    subtitle: 'The Arabic language and its grammar (Nahw)',
...
export const GRAPH_EDGES = [
  ...
  { a: 'arabiyyah', b: 'jumlah-mufeedah', relation: 'prerequisite' },
  ...
  { a: 'arabiyyah', b: 'lesson-arb-found-1', relation: 'lesson' },
  ...
  { a: 'arabiyyah', b: 'lesson-arb-beyond-4', relation: 'lesson' },

  { a: 'arabiyyah', b: 'verse-tawbah-93', relation: 'evidence' },
  { a: 'irab', b: 'verse-tawbah-93', relation: 'evidence' },

  // Deliberately no edge between arabiyyah/irab and any Tawheed
  // concept: Arabiyyah is a language discipline and Tawheed is
  // theology. The two courses don't share a genuine conceptual
  // dependency, only the same underlying language the Qur'an itself
  // is written in, which is too general a link to be a useful graph
  // edge. Leaving this absent is intentional, not an oversight.
];
